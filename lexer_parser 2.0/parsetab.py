...
_lr_signature = 'NUMBER PLUS TIMES MINUS DIVIDEexpression : expression expression PLUSexpression : expression expression MINUSexpression : expression expression TIMESexpression : expression expression DIVIDEexpression : termterm : factorfactor : NUMBER'
...
_lr_productions = [
  ...
  ('expression -> expression expression TIMES','expression',3,'p_expression_times','parser_rules.py',13),
  ('expression -> expression expression DIVIDE','expression',3,'p_expression_divide','parser_rules.py',17),
